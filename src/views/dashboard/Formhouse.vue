    ...
    <div style="padding:40px">  
        <v-card style="box-shadow: 0px 2px 4px rgba(50, 50, 71, 0.06), 0px 2px 2px rgba(50, 50, 71, 0.06);border: 1px solid #E8E8E8;">
          <div style="padding: 28px;">
             <v-stepper v-model="e1" style="margin-bottom:40px">
                <v-stepper-header>
                  <v-stepper-step step="1" :complete="e1 > 1">Identitas rumah</v-stepper-step>
                  <v-divider></v-divider>
                  <v-stepper-step step="2" :complete="e1 > 2">Data Keluarga</v-stepper-step>
                  <v-divider></v-divider>
                  <v-stepper-step step="3" :complete="e1 > 3">Data Rumah</v-stepper-step>
                  <v-divider></v-divider>
               ...
               <v-stepper-items>
                  ...
                  <v-col cols="12">
                    ...
                    <div style="float:right">
                      ...
                      <v-btn dark color="warning" @click="storeFinish()" style="margin-right:15px" class="elevation-0">
                          Finish
                      </v-btn>
                      ...
                      <v-card-actions step="2" v-else-if="e1==2">
                        <v-row>
                          <v-col cols="12" md="6">
                            <v-text-field
                        ...
                        <v-col cols="12">
                          <div style="float:right">
                            <v-btn @click="e1=0" tile small color="#FFFFFF" style="border: 1px solid rgba(151, 151, 151, 0.45);color:#979797;box-sizing: border-box;border-radius: 4px;width: 120px;height: 39px;margin-right:15px" class="elevation-0">
                                Cancel
                            </v-btn>
                            <v-btn dark color="warning" @click="storeFinish()" style="margin-right:15px" class="elevation-0">
                                Finish
                            </v-btn>
                            <v-btn color="primary" dark @click="e1=3" class="elevation-0">
                                Next
                            </v-btn>
                        </div>
                        </v-col>
                      ...
                      <v-card-actions step="3" v-else-if="e1==3" >
                        ...
                        ></v-select>
                          ...
                          <v-col cols="12">
                            <div style="float:right">
                            <v-btn @click="e1=2" color="#FFFFFF" style="border: 1px solid rgba(151, 151, 151, 0.45);color:#979797;box-sizing: border-box;border-radius: 4px;width: 120px;height: 39px;margin-right:15px" class="elevation-0">
                                Cancel
                            </v-btn>
                            <v-btn dark color="warning" @click="storeFinish()" style="margin-right:15px" class="elevation-0">
                                Finish
                            </v-btn>
                            <v-btn dark color="primary" @click="store()" class="elevation-0">
                                Next
                            </v-btn>
                        </div>
                          </v-col>
