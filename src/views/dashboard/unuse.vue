             ...
             <v-stepper style="margin-bottom:40px">
               ...
               <v-stepper-items>
                  ...
                  <v-card style="margin-top:30px;box-shadow: 0px 2px 4px rgba(50, 50, 71, 0.06), 0px 2px 2px rgba(50, 50, 71, 0.06);border: 1px solid #E8E8E8;">
                    <div style="padding: 28px;">
                        <v-card-actions>
                    <v-btn dark height="40" width="120" color="#E77271" @click="$router.go(-1)" class="elevation-0">
                      Clear
                    </v-btn>
                    <v-btn dark color="primary" height="40" width="130" @click="store()" class="elevation-0">
                      Set Lokasi
                    </v-btn>
                  </v-card-actions>
                    </div>
